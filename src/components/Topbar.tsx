        ...
        <div className="container mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-3 px-3 py-2 bg-blue-50 text-blue-900 rounded hover:bg-blue-100 transition-colors text-sm font-medium"
              title="Lihat Profil"
            >
              <img
              ...
              <div className="flex flex-col text-left leading-tight">
                <span className="text-sm font-semibold text-gray-900">Insp. Ahmad Faiz</span>
                <span className="text-xs text-gray-600">JSPT · PDRM</span>
              </div>
            </button>
            <button
