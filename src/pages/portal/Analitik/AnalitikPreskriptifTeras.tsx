            ...
            <div className="flex flex-grow">
                ...
                <main className="flex-grow p-6">
                    <div className="container mx-auto">
                        <PageTitle>Analitik Preskriptif - {teras?.["Nama Teras"] || "Teras"}</PageTitle>
                        <SectionCard title={`${teras?.["Kod Teras"]} - ${teras?.["Nama Teras"]}`}>
                            <p className="text-gray-600">Analitik Preskriptif content for this Teras will be implemented here.</p>
                        </SectionCard>
                    </div>
                </main>
            </div>
