            ...
            <div className="flex flex-grow">
                ...
                <main className="flex-grow p-6">
                    <div className="container mx-auto">
                        <PageTitle>Analitik Prediktif - {komponen?.["Nama Komponen"] || "Komponen"}</PageTitle>
                        <SectionCard title={`${teras?.["Nama Teras"]} - ${komponen?.["Nama Komponen"]}`}>
                            <div className="space-y-4">
                                ...
                                <p className="text-gray-600">Analitik Prediktif content for this Komponen will be implemented here.</p>
                            </div>
                        </SectionCard>
                    </div>
                </main>
